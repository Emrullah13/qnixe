...
exports.run = async (client, msg, args) => {
    ...
    request(`https://qnixe.ga/api/botlar/${args[0]}`, function (error, response, body) {
    if (error) return msg.channel.send('Hata:', error);
      ...
      request(`https://qnixe.ga/api/tumbotlar`, function (errorr, responsee, bodyy) {
    ...
    .setFooter('https://qnixe.ga sisteminde bot aramaktadır.')
